...
public class DynHSNode1 {
    ...
    /* for initiation only */
    DynHSNode1(int nEle, long mask, List<Long> edges) {
        elements = 0;
    ...
    DynHSNode1 getChildNode(int e, long childCand) {
        DynHSNode1 childNode = new DynHSNode1();
        childNode.updateContextFromParent(e, childCand, this);
        return childNode;
    }

    void updateContextFromParent(int e, long outerCand, DynHSNode1 parentNode) {
